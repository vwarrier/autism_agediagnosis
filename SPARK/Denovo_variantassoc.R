...
summary(lm(diagnosis_age3 ~ denovo + sex + age_at_registration_years, data = merged_total))
summary(lm(diagnosis_age3 ~ PTV + sex + age_at_registration_years, data = merged_total))
summary(lm(diagnosis_age3 ~ missense + sex + age_at_registration_years, data = merged_total))
